				...
				<div class="col-lg-9 col-md-9">
					<nav class="main-menu">
						<ul>
							...
							<li><a href="{{route('etudiant.form')}}">Etudiant</a></li>
							<li><a href="{{route('register.prof')}}">Enseignant</a></li>
						</ul>
					</nav>
				</div>
			</div>
			...
			<div class="row course-items-area">
				...
				<div class="mix col-lg-3 col-md-4 col-sm-6 finance">
					<div class="course-item">
						<div class="course-thumb set-bg" data-setbg="{{asset('/assets/img/courses/1.jpg')}}">
				...
				<div class="mix col-lg-3 col-md-4 col-sm-6 design">
					<div class="course-item">
						<div class="course-thumb set-bg" data-setbg="{{asset('/assets/img/courses/2.jpg')}}">
							<div class="price">Price: $15</div>
						</div>
						<div class="course-info">
							<div class="course-text">
