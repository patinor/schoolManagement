...
<body class="sub_page">
  ...
  <div class="list-group">
   <p>
    ...
    <button type="button" class="list-group-item list-group-item-action">{{$lecon->titre}} <a href="{{route('play.Video.Lecon',['id'=>$lecon->id])}}" class="alert alert-info"><i class="bi bi-play-fill"></i></a></button>
    @endforeach
  </div>
  {{$leconAll->links()}}
